...
## Day 2 — Backend foundation + synthetic data
...
## Day 3 — ML baseline, and the first real bug
...
## Day 4 — Graph engine, and a second leakage bug
...
## Day 5 — Decision engine (hero feature) + backend API
...
script) — fixed by switching to random sampling.
